...
public interface ProcessingPipelineRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query(value = """
            select
                ...
                p2.reason_code as pacs002ReasonCode,
                p2.received_timestamp as pacs002ReceivedTimestamp,
                a.adm002_id as admi002Id,
                a.reject_reason_description as admi002RejectReasonDescription,
                a.error_description as admi002ErrorDescription,
                a.reject_reason_code as admi002RejectReasonCode,
                a.error_code as admi002ErrorCode,
