...
public class SettlementTransactionServiceImpl implements SettlementTransactionService {
    ...
    public void processPacs002(Transaction transaction, PACS002 pacs002) {
        ...
        if ("ACSC".equals(status) || "ACCP".equals(status)) {
            ...
            log.info("Recording returned amount for transactionId={} without auto-crediting sender account {}",
                    lockedTransaction.getTransactionId(), settlementDebit.getSenderAccount());
